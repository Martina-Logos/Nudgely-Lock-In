  ...
  return (
    <div className="page-auth">
      ...
      <div className="flex flex-col gap-4 mb-6 animate-slide-up" style={{ animationDelay: '0.1s' }}>
        ...
        <button className="w-full flex items-center justify-center gap-3 bg-white border border-[#E3DBE6] rounded-xl py-3.5 text-sm font-medium text-[#2D1F35] hover:border-[#23BBB7] transition-colors duration-200"
