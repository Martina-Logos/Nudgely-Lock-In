  ...
  return (
    <div className="page-auth signup-page">
      <div className="signup-card">
        ...
        <div className="signup-copy animate-slide-up">
          <h1 className="signup-title" style={{ color: '#744D83', fontFamily: '"DM Serif Display", serif' }}>
            Create your account
          </h1>
          <p className="signup-subtitle">Start building better focus habits today</p>
        </div>

        <div className="signup-form animate-slide-up" style={{ animationDelay: '0.1s' }}>
          <div>
        ...
        <div className="signup-actions animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <button className="btn-primary signup-primary-button" onClick={handleSubmit} disabled={!isValid || loading}>
